module HashSign::hash_sign1 {
    ...
    struct Document has key, store, copy {
        id: u64,
        content_hash: String,
        creator: address,
    ...
    public entry fun create_document(creator: &signer, content_hash: String, signers: vector<address>) acquires DocumentStore {
